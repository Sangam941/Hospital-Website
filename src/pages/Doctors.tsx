...
const doctors = [
    ...
    },
    {
        ...
        qualifications: 'MBBS, MS, DM - Neurology',
        ...
        <div>
            ...
            <section className="hero-bg py-20 px-4 mb-12">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <h1 className="text-5xl font-extrabold text-white tracking-tight mb-4">Meet Our Specialists</h1>
                    <p className="text-blue-50 text-lg max-w-3xl mx-auto leading-relaxed">
                        Connect with our world-class medical professionals dedicated to providing exceptional care across 30+ specialized departments.
                    </p>
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 pb-16">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4 border-b border-slate-200 pb-6">
                    <p className="text-slate-500 font-medium">Showing <span className="text-slate-900 font-bold">24 Expert Doctors</span></p>
                ...
                <div className="mt-16 bg-slate-50 rounded-2xl p-8 md:p-10 border border-slate-100 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="max-w-xl text-center md:text-left">
                        <h2 className="text-3xl font-bold text-slate-900 mb-3">Can't find the right doctor?</h2>
                        <p className="text-slate-600 text-lg">
                            Our patient care coordinators are ready to help you find the best match for your needs.
                        </p>
                    </div>
